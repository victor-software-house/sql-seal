...
### Manual instalation
To manually install the package, open [Releases](https://github.com/victor-software-house/sql-seal/releases) and download .zip of the last one. Unzip it in your vault under `.obsidian/plugins/sqlseal`.

Alternatively, search for "SQLSeal" in the Community Plugins tab in Obsidian Settings.
