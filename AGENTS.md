...
- In the normal Changesets path, do not hand-write `Unreleased` changelog
  entries; the release PR generated by `pnpm run ci:version` owns
  `CHANGELOG.md`. For an explicit emergency manual release, update
